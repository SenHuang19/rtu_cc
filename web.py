...
class run(Resource):
    ...
    def post(self):   
        ...
        load_template(['template/global','output'],'output.template','output','output1.idf',data)
        ...
        load_template('./template/devices','MinOAFraction_upgrade.template','output','MinOAFraction',data)
        ...
        load_template(['template/global','output'],'output.template','output','output2.idf',data)  
        os.chdir('/home/developer/idf/output')
